...
export default function Notes() {
    ...
    // KODE DOSEN: Handle untuk aksi hapus data
    ...
    return (
        <div className="max-w-2xl mx-auto p-6">
            ...
            {/* Tempat Menampilkan Status Alert */}
            {error && <div className="p-4 mb-4 text-sm text-red-800 bg-red-50 rounded-2xl">{error}</div>}
            {success && <div className="p-4 mb-4 text-sm text-emerald-800 bg-emerald-50 rounded-2xl">{success}</div>}
